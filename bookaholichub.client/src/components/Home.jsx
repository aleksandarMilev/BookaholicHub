        ...
        <div className="bg-gray-100">
            ...
            <div className={`${cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'} fixed right-0 top-0 max-w-xs w-full h-full px-6 py-4 transition duration-300 transform overflow-y-auto bg-white border-l-2 border-gray-300`}>
                ...
                {Array(3).fill().map((_, index) => (
                    <div key={index} className="flex justify-between mt-2">
                        <div className="flex items-center">
                            <img src="https://via.placeholder.com/50" alt="Product" className="h-10 w-10 rounded object-cover" />
                            <div className="ml-2">
                                <h3 className="text-sm font-medium text-gray-700">Product Name</h3>
                                <span className="text-xs text-gray-500">Quantity: 1</span>
                            </div>
                        </div>
                ...
                <div className="flex justify-between">
                    ...
                    <span className="text-gray-700 font-medium">$30.00</span>
                </div>
                <button className="mt-4 w-full bg-blue-500 text-white font-semibold py-2 rounded-lg">Checkout</button>
            </div>
            <main className="my-8">
                        ...
                        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
                            ...
                            {[
                                ...
                                <div key={index} className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                                    <div className="flex items-end justify-end h-56 w-full bg-cover" style={{ backgroundImage: `url('${product.imageUrl}')` }}>
